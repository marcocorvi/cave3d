...
class Cave3DTube
{
  private static final String TAG = "Cave3D TB";
  ...
  // void dumpTube()
  // {
  //   Log.v("TopoGL", "Tube " + xs1.name() + "--" + xs2.name() + " triangles " + triangles.size() );
  // }
  ...
  private void computeTube()
  {
    ...
    // Log.v("TopoGL", "Tube " + xs1.name() + "--" + xs2.name() + " compute tube " + xs1.size() + " " + xs2.size() + " R " + reverse1 + " " + reverse2 );
    // xs1.dump();
    // xs2.dump();
    ...
    boolean done2 = false;
    boolean inc1 = false;
    // Log.v("TopoGL", "start " + k1 + " " + k2 );
    do {
      if ( done1 ) {
        int k2p = (k2+1) % k2size;
        done2 = k2p == 0;
        // Log.v("TopoGL", "2-insert " + k2 + " -> " + k2p );
        ...
        if ( inc1 ) {
          ...
          done2 = k2p == 0;
          inc1 = false;
          // Log.v("TopoGL", "2-insert " + k2 + " -> " + k2p + " a1 = a2 " + a10 );
          Vector3D p2 = xs2.point( k2p, reverse2 );
          addTriangle( p10, p2, p20 );
          p20 = p2;
          k2 = k2p;
          ...
          done1 = k1p == 0;
          inc1 = true;
          // Log.v("TopoGL", "1-insert " + k1 + " -> " + k1p + " a1 = a2 " + a10 );
          Vector3D p1 = xs1.point( k1p, reverse1 );
          addTriangle(p10, p1, p20 );
          p10 = p1;
          k1 = k1p;
        ...
        done1 = k1p == 0;
        inc1 = true;
        // Log.v("TopoGL", "1-insert " + k1 + " -> " + k1p + " a1 < a2 " + a10 + " < " + a20 );
        Vector3D p1 = xs1.point( k1p, reverse1 );
        addTriangle(p10, p1, p20 );
        p10 = p1;
        k1 = k1p;
        ...
        done2 = k2p == 0;
        inc1 = false;
        // Log.v("TopoGL", "2-insert " + k2 + " -> " + k2p + " a1 > a2 " + a10 + " > " + a20 );
        Vector3D p2 = xs2.point( k2p, reverse2 );
        addTriangle( p10, p2, p20 );
        p20 = p2;
        k2 = k2p;
