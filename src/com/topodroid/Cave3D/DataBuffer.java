...
class DataBuffer
{
  ...
  FloatBuffer addFloats( float[] values )
  {
    ...
    // Log.v("TopoGL", "add floats: cap " + mCapacity + "/" + mData.capacity() + " limit " + mData.limit() + " pos " + mPos + "/" + mData.position() + " len " + values.length );
  ...
  private DataBuffer( int type, int cap, int delta ) 
  {
    ...
    // Log.v("TopoGL", "Data Buffer cstr cap " + mCapacity + " pos " + mPos );
  }
  ...
  private void realloc()
  {
    ...
    mData.position( mPos );
    // Log.v("TopoGL", "Data Buffer realloc cap " + mCapacity + "/" + mData.capacity() 
  ...
  private void extend( int delta )
  {
    if ( mPos + delta > mCapacity ) {
      // Log.v("TopoGL", "extend pos " + mPos + " delta " + delta + " cap " + mCapacity );
