...
*/
  ...
  private static int compileShader( int type, String code )
  {
    ...
    if ( id == 0 ) {
      ...
      Log.e("TopoGL", "failed create shader " + code.substring(0,pos) );
      return 0;
    }
    ...
    if ( status[0] == 0 ) {
      int pos = code.indexOf('\n');
      Log.e("TopoGL", "failed compile shader " + code.substring(0,pos) + ": " + GLES20.glGetShaderInfoLog( id ) );
  ...
  private  static int linkProgram( int vertexShader, int fragmentShader )
  {
    ...
    if ( program == 0 ) {
      Log.e("TopoGL", "failed create program. vertex " + vertexShader + " fragment " + fragmentShader );
      return 0;
    }
    ...
    if ( status[0] == 0 ) {
      Log.e("TopoGL", "failed link program: " + GLES20.glGetShaderInfoLog( program ) );
