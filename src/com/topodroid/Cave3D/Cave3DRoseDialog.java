...
public class Cave3DRoseDialog extends Dialog
{
  ...
  public Cave3DRoseDialog( Context context, Cave3DRenderer renderer )
  {
    super( context );
    mContext = context;
  ...
  private void evalRoseDiagram( Cave3DRenderer renderer )
  {
    mNr = 72;
