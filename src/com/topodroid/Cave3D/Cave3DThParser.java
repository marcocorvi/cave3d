...
public class Cave3DThParser
{
  ...
  private ArrayList< Cave3DSurvey > surveys;
  private ArrayList< Cave3DFix > fixes;
  private ArrayList< Cave3DStation > stations;
  private ArrayList< Cave3DShot > shots;   // centerline shots
  private ArrayList< Cave3DShot > splays;  // splay shots
  ...
  // {
  //   if ( args.length > 0 ) {
  //     Cave3DThParser c3DthParser = new Cave3DThParser( args[0] );
  //   }
  // }
}
