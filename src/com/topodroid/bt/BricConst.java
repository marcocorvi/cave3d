...
{
  public static int DATA_PRIM = 1;
  public static int DATA_META = 2;
  public static int DATA_ERR  = 3;
  public static int DATA_TIME = 4;
  ...
  static int   getSamples( byte[] bytes )  { return BleUtils.getShort( bytes, 16 ); }
